      ...
      <div class="row">
        ...
        <div class="control-group">
          <button
            ...
            @pointerup=${()=>this._endHold(e)}
            @pointercancel=${()=>this._endHold(e)}
