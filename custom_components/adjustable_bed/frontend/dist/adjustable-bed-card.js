...
var Je=Object.defineProperty;var Ze=Object.getOwnPropertyDescriptor;var _=(n,s,e,t)=>{for(var i=t>1?void 0:t?Ze(s,e):s,o=n.length-1,r;o>=0;o--)(r=n[o])&&(i=(t?r(s,e,i):r(i))||i);return t&&i&&Je(s,e,i),i};var S="adjustable_bed";function xe(n){for(let s of["left","right","both"]){let e=`_${s}`;if(n.endsWith(e))return{key:n.slice(0,-e.length),side:s}}return{key:n}}var H=["graphic","motors","firmness","presets","memory","lighting","massage","utility","climate","connection"],be=["back","legs","back_legs","head","feet","lumbar","pillow","neck","tilt","hip","bed_height","stair"],oe=["preset_flat","preset_zero_g","preset_anti_snore","preset_tv","preset_lounge","preset_swing","preset_incline","preset_both_up","preset_yoga"],Xe=n=>n.split(".",1)[0],$e=n=>n.translation_key??"";function Qe(){return{motors:[],firmness:[],presets:[],memory:[],presence:[],lights:{},massage:{buttons:[],numbers:[]},climate:{entities:[],selects:[]},utility:[]}}function x(n,s,e){let t=Qe();if(!s||!n?.entities)return t;let i=new Map,o=p=>{let h=i.get(p);return h||(h={key:p},i.set(p,h)),h},r=new Map,c=new Map,a=p=>{let h=c.get(p);return h||(h={slot:p},c.set(p,h)),h};for(let p of Object.values(n.entities)){if(p.device_id!==s||p.platform!==S||p.hidden)continue;let h=p.entity_id,B=Xe(h),se=$e(p);if(!se)continue;let ye=xe(se),Ye=n.states[h]?.attributes.bed_side??n.states[h]?.attributes.side??ye.side;if(e&&Ye!==e)continue;let g=e?ye.key:se,k;switch(B){case"cover":o(g).cover=h;break;case"sensor":g.endsWith("_angle")&&(o(g.slice(0,-6)).angle=h);break;case"number":g.endsWith("_position")?o(g.slice(0,-9)).position=h:g.startsWith("massage_")&&g.endsWith("_intensity")?t.massage.numbers.push(h):g==="light_level"?t.lights.level=h:g.startsWith("sleep_number_setting")&&t.firmness.push(h);break;case"button":oe.includes(g)||g.startsWith("preset_")?(k=g.match(/^preset_memory_(\d+)$/))?a(Number(k[1])).goto=h:r.set(g,h):(k=g.match(/^program_memory_(\d+)$/))?a(Number(k[1])).save=h:g==="stop"||g==="stop_both"?t.stop=h:g==="connect"?t.connect=h:g==="disconnect"?t.disconnect=h:g==="toggle_light"?t.lights.toggle=h:g==="light_cycle"?t.lights.cycle=h:g==="sync_positions"||g==="child_lock_toggle"||g==="auxiliary_action"||g==="wake_controller"||g==="reset_defaults"||g==="factory_reset"?t.utility.push(h):g.startsWith("massage_")?t.massage.buttons.push(h):(k=g.match(/^(.+)_(up|down)$/))&&(o(k[1])[k[2]]=h);break;case"switch":g==="under_bed_lights"?t.lights.switch=h:g==="synchro_mode"?t.synchro=h:g==="linak_automatic_drive"&&t.utility.push(h);break;case"light":t.lights.light=h;break;case"binary_sensor":g==="ble_connection"?t.connectivity=h:g.startsWith("bed_presence")&&t.presence.push(h);break;case"select":g==="light_timer"?t.lights.timer=h:g==="massage_timer"?t.massage.timer=h:/thermal|footwarming|foundation/.test(g)&&t.climate.selects.push(h);break;case"climate":t.climate.entities.push(h);break}}let u=[...i.keys()],f=[...be.filter(p=>i.has(p)),...u.filter(p=>!be.includes(p)).sort()];t.motors=f.map(p=>i.get(p)).filter(p=>p.cover||p.up||p.down||p.angle||p.position);let v=[...r.keys()];return t.presets=[...oe.filter(p=>r.has(p)),...v.filter(p=>!oe.includes(p)).sort()].map(p=>r.get(p)),t.memory=[...c.values()].filter(p=>p.goto||p.save).sort((p,h)=>p.slot-h.slot),t}function we(n,s){return!s||!n?.entities?!1:Object.values(n.entities).some(e=>e.device_id===s&&e.platform===S&&(n.states[e.entity_id]?.attributes.bed_side==="both"||xe($e(e)).side==="both"))}function ne(n,s){if(!s||!n?.devices)return[];let e=t=>{let i=n.devices[t];return(i?.name_by_user??i?.name??t).toLowerCase()};return Object.values(n.devices).filter(t=>t.via_device_id===s).map(t=>t.id).sort((t,i)=>e(t)<e(i)?-1:e(t)>e(i)?1:0)}function Ee(n,s){if(!s||!n?.devices)return s;let e=n.devices[s]?.via_device_id;return e&&n.devices[e]&&ne(n,e).length?e:s}function z(n){let s=n.lights;return n.motors.length===0&&!n.synchro&&n.firmness.length===0&&n.presets.length===0&&n.memory.length===0&&!n.stop&&!n.connect&&!n.disconnect&&!n.connectivity&&!s.light&&!s.switch&&!s.level&&!s.toggle&&!s.cycle&&!s.timer&&n.massage.buttons.length===0&&n.massage.numbers.length===0&&!n.massage.timer&&n.climate.entities.length===0&&n.climate.selects.length===0&&n.utility.length===0}var re="adjustable-bed-card",ke={type:re,name:"Adjustable Bed Card",description:"Native control card for the Adjustable Bed integration.",preview:!0,documentationURL:"https://github.com/kristofferR/ha-adjustable-bed",getEntitySuggestion:(n,s)=>{let e=n.entities[s];return e?.platform!==S||!e.device_id?null:{config:{type:`custom:${re}`,device_id:e.device_id}}}};function et(n){let s=n.customCards??=[],e=s.findIndex(t=>t.type===re);e===-1?s.push(ke):s[e]=ke}typeof window<"u"&&et(window);var Y=globalThis,J=Y.ShadowRoot&&(Y.ShadyCSS===void 0||Y.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ae=Symbol(),Se=new WeakMap,j=class{constructor(s,e,t){if(this._$cssResult$=!0,t!==ae)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=s,this.t=e}get styleSheet(){let s=this.o,e=this.t;if(J&&s===void 0){let t=e!==void 0&&e.length===1;t&&(s=Se.get(e)),s===void 0&&((this.o=s=new CSSStyleSheet).replaceSync(this.cssText),t&&Se.set(e,s))}return s}toString(){return this.cssText}},Ae=n=>new j(typeof n=="string"?n:n+"",void 0,ae),U=(n,...s)=>{let e=n.length===1?n[0]:s.reduce((t,i,o)=>t+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+n[o+1],n[0]);return new j(e,n,ae)},Pe=(n,s)=>{if(J)n.adoptedStyleSheets=s.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of s){let t=document.createElement("style"),i=Y.litNonce;i!==void 0&&t.setAttribute("nonce",i),t.textContent=e.cssText,n.appendChild(t)}},ce=J?n=>n:n=>n instanceof CSSStyleSheet?(s=>{let e="";for(let t of s.cssRules)e+=t.cssText;return Ae(e)})(n):n;var{is:tt,defineProperty:it,getOwnPropertyDescriptor:st,getOwnPropertyNames:ot,getOwnPropertySymbols:nt,getPrototypeOf:rt}=Object,Z=globalThis,Ce=Z.trustedTypes,at=Ce?Ce.emptyScript:"",ct=Z.reactiveElementPolyfillSupport,F=(n,s)=>n,G={toAttribute(n,s){switch(s){case Boolean:n=n?at:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,s){let e=n;switch(s){case Boolean:e=n!==null;break;case Number:e=n===null?null:Number(n);break;case Object:case Array:try{e=JSON.parse(n)}catch{e=null}}return e}},X=(n,s)=>!tt(n,s),Me={attribute:!0,type:String,converter:G,reflect:!1,useDefault:!1,hasChanged:X};Symbol.metadata??=Symbol("metadata"),Z.litPropertyMetadata??=new WeakMap;var $=class extends HTMLElement{static addInitializer(s){this._$Ei(),(this.l??=[]).push(s)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(s,e=Me){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(s)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(s,e),!e.noAccessor){let t=Symbol(),i=this.getPropertyDescriptor(s,t,e);i!==void 0&&it(this.prototype,s,i)}}static getPropertyDescriptor(s,e,t){let{get:i,set:o}=st(this.prototype,s)??{get(){return this[e]},set(r){this[e]=r}};return{get:i,set(r){let c=i?.call(this);o?.call(this,r),this.requestUpdate(s,c,t)},configurable:!0,enumerable:!0}}static getPropertyOptions(s){return this.elementProperties.get(s)??Me}static _$Ei(){if(this.hasOwnProperty(F("elementProperties")))return;let s=rt(this);s.finalize(),s.l!==void 0&&(this.l=[...s.l]),this.elementProperties=new Map(s.elementProperties)}static finalize(){if(this.hasOwnProperty(F("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(F("properties"))){let e=this.properties,t=[...ot(e),...nt(e)];for(let i of t)this.createProperty(i,e[i])}let s=this[Symbol.metadata];if(s!==null){let e=litPropertyMetadata.get(s);if(e!==void 0)for(let[t,i]of e)this.elementProperties.set(t,i)}this._$Eh=new Map;for(let[e,t]of this.elementProperties){let i=this._$Eu(e,t);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(s){let e=[];if(Array.isArray(s)){let t=new Set(s.flat(1/0).reverse());for(let i of t)e.unshift(ce(i))}else s!==void 0&&e.push(ce(s));return e}static _$Eu(s,e){let t=e.attribute;return t===!1?void 0:typeof t=="string"?t:typeof s=="string"?s.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(s=>this.enableUpdating=s),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(s=>s(this))}addController(s){(this._$EO??=new Set).add(s),this.renderRoot!==void 0&&this.isConnected&&s.hostConnected?.()}removeController(s){this._$EO?.delete(s)}_$E_(){let s=new Map,e=this.constructor.elementProperties;for(let t of e.keys())this.hasOwnProperty(t)&&(s.set(t,this[t]),delete this[t]);s.size>0&&(this._$Ep=s)}createRenderRoot(){let s=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Pe(s,this.constructor.elementStyles),s}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(s=>s.hostConnected?.())}enableUpdating(s){}disconnectedCallback(){this._$EO?.forEach(s=>s.hostDisconnected?.())}attributeChangedCallback(s,e,t){this._$AK(s,t)}_$ET(s,e){let t=this.constructor.elementProperties.get(s),i=this.constructor._$Eu(s,t);if(i!==void 0&&t.reflect===!0){let o=(t.converter?.toAttribute!==void 0?t.converter:G).toAttribute(e,t.type);this._$Em=s,o==null?this.removeAttribute(i):this.setAttribute(i,o),this._$Em=null}}_$AK(s,e){let t=this.constructor,i=t._$Eh.get(s);if(i!==void 0&&this._$Em!==i){let o=t.getPropertyOptions(i),r=typeof o.converter=="function"?{fromAttribute:o.converter}:o.converter?.fromAttribute!==void 0?o.converter:G;this._$Em=i;let c=r.fromAttribute(e,o.type);this[i]=c??this._$Ej?.get(i)??c,this._$Em=null}}requestUpdate(s,e,t,i=!1,o){if(s!==void 0){let r=this.constructor;if(i===!1&&(o=this[s]),t??=r.getPropertyOptions(s),!((t.hasChanged??X)(o,e)||t.useDefault&&t.reflect&&o===this._$Ej?.get(s)&&!this.hasAttribute(r._$Eu(s,t))))return;this.C(s,e,t)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(s,e,{useDefault:t,reflect:i,wrapped:o},r){t&&!(this._$Ej??=new Map).has(s)&&(this._$Ej.set(s,r??e??this[s]),o!==!0||r!==void 0)||(this._$AL.has(s)||(this.hasUpdated||t||(e=void 0),this._$AL.set(s,e)),i===!0&&this._$Em!==s&&(this._$Eq??=new Set).add(s))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let s=this.scheduleUpdate();return s!=null&&await s,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,o]of this._$Ep)this[i]=o;this._$Ep=void 0}let t=this.constructor.elementProperties;if(t.size>0)for(let[i,o]of t){let{wrapped:r}=o,c=this[i];r!==!0||this._$AL.has(i)||c===void 0||this.C(i,void 0,o,c)}}let s=!1,e=this._$AL;try{s=this.shouldUpdate(e),s?(this.willUpdate(e),this._$EO?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$EM()}catch(t){throw s=!1,this._$EM(),t}s&&this._$AE(e)}willUpdate(s){}_$AE(s){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(s)),this.updated(s)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(s){return!0}update(s){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(s){}firstUpdated(s){}};$.elementStyles=[],$.shadowRootOptions={mode:"open"},$[F("elementProperties")]=new Map,$[F("finalized")]=new Map,ct?.({ReactiveElement:$}),(Z.reactiveElementVersions??=[]).push("2.1.2");var me=globalThis,Re=n=>n,Q=me.trustedTypes,Te=Q?Q.createPolicy("lit-html",{createHTML:n=>n}):void 0,Ne="$lit$",w=`lit$${Math.random().toFixed(9).slice(2)}$`,Le="?"+w,lt=`<${Le}>`,C=document,K=()=>C.createComment(""),W=n=>n===null||typeof n!="object"&&typeof n!="function",fe=Array.isArray,dt=n=>fe(n)||typeof n?.[Symbol.iterator]=="function",le=`[ \t
\f\r]`,I=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Be=/-->/g,He=/>/g,A=RegExp(`>|${le}(?:([^\\s"'>=/]+)(${le}*=${le}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ze=/'/g,Oe=/"/g,je=/^(?:script|style|textarea|title)$/i,ve=n=>(s,...e)=>({_$litType$:n,strings:s,values:e}),d=ve(1),ee=ve(2),Bt=ve(3),M=Symbol.for("lit-noChange"),l=Symbol.for("lit-nothing"),De=new WeakMap,P=C.createTreeWalker(C,129);function Ue(n,s){if(!fe(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return Te!==void 0?Te.createHTML(s):s}var ht=(n,s)=>{let e=n.length-1,t=[],i,o=s===2?"<svg>":s===3?"<math>":"",r=I;for(let c=0;c<e;c++){let a=n[c],u,f,v=-1,p=0;for(;p<a.length&&(r.lastIndex=p,f=r.exec(a),f!==null);)p=r.lastIndex,r===I?f[1]==="!--"?r=Be:f[1]!==void 0?r=He:f[2]!==void 0?(je.test(f[2])&&(i=RegExp("</"+f[2],"g")),r=A):f[3]!==void 0&&(r=A):r===A?f[0]===">"?(r=i??I,v=-1):f[1]===void 0?v=-2:(v=r.lastIndex-f[2].length,u=f[1],r=f[3]===void 0?A:f[3]==='"'?Oe:ze):r===Oe||r===ze?r=A:r===Be||r===He?r=I:(r=A,i=void 0);let h=r===A&&n[c+1].startsWith("/>")?" ":"";o+=r===I?a+lt:v>=0?(t.push(u),a.slice(0,v)+Ne+a.slice(v)+w+h):a+w+(v===-2?c:h)}return[Ue(n,o+(n[e]||"<?>")+(s===2?"</svg>":s===3?"</math>":"")),t]},q=class n{constructor({strings:s,_$litType$:e},t){let i;this.parts=[];let o=0,r=0,c=s.length-1,a=this.parts,[u,f]=ht(s,e);if(this.el=n.createElement(u,t),P.currentNode=this.el.content,e===2||e===3){let v=this.el.content.firstChild;v.replaceWith(...v.childNodes)}for(;(i=P.nextNode())!==null&&a.length<c;){if(i.nodeType===1){if(i.hasAttributes())for(let v of i.getAttributeNames())if(v.endsWith(Ne)){let p=f[r++],h=i.getAttribute(v).split(w),B=/([.?@])?(.*)/.exec(p);a.push({type:1,index:o,name:B[2],strings:h,ctor:B[1]==="."?he:B[1]==="?"?pe:B[1]==="@"?ue:D}),i.removeAttribute(v)}else v.startsWith(w)&&(a.push({type:6,index:o}),i.removeAttribute(v));if(je.test(i.tagName)){let v=i.textContent.split(w),p=v.length-1;if(p>0){i.textContent=Q?Q.emptyScript:"";for(let h=0;h<p;h++)i.append(v[h],K()),P.nextNode(),a.push({type:2,index:++o});i.append(v[p],K())}}}else if(i.nodeType===8)if(i.data===Le)a.push({type:2,index:o});else{let v=-1;for(;(v=i.data.indexOf(w,v+1))!==-1;)a.push({type:7,index:o}),v+=w.length-1}o++}}static createElement(s,e){let t=C.createElement("template");return t.innerHTML=s,t}};function O(n,s,e=n,t){if(s===M)return s;let i=t!==void 0?e._$Co?.[t]:e._$Cl,o=W(s)?void 0:s._$litDirective$;return i?.constructor!==o&&(i?._$AO?.(!1),o===void 0?i=void 0:(i=new o(n),i._$AT(n,e,t)),t!==void 0?(e._$Co??=[])[t]=i:e._$Cl=i),i!==void 0&&(s=O(n,i._$AS(n,s.values),i,t)),s}var de=class{constructor(s,e){this._$AV=[],this._$AN=void 0,this._$AD=s,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(s){let{el:{content:e},parts:t}=this._$AD,i=(s?.creationScope??C).importNode(e,!0);P.currentNode=i;let o=P.nextNode(),r=0,c=0,a=t[0];for(;a!==void 0;){if(r===a.index){let u;a.type===2?u=new V(o,o.nextSibling,this,s):a.type===1?u=new a.ctor(o,a.name,a.strings,this,s):a.type===6&&(u=new ge(o,this,s)),this._$AV.push(u),a=t[++c]}r!==a?.index&&(o=P.nextNode(),r++)}return P.currentNode=C,i}p(s){let e=0;for(let t of this._$AV)t!==void 0&&(t.strings!==void 0?(t._$AI(s,t,e),e+=t.strings.length-2):t._$AI(s[e])),e++}},V=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(s,e,t,i){this.type=2,this._$AH=l,this._$AN=void 0,this._$AA=s,this._$AB=e,this._$AM=t,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let s=this._$AA.parentNode,e=this._$AM;return e!==void 0&&s?.nodeType===11&&(s=e.parentNode),s}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(s,e=this){s=O(this,s,e),W(s)?s===l||s==null||s===""?(this._$AH!==l&&this._$AR(),this._$AH=l):s!==this._$AH&&s!==M&&this._(s):s._$litType$!==void 0?this.$(s):s.nodeType!==void 0?this.T(s):dt(s)?this.k(s):this._(s)}O(s){return this._$AA.parentNode.insertBefore(s,this._$AB)}T(s){this._$AH!==s&&(this._$AR(),this._$AH=this.O(s))}_(s){this._$AH!==l&&W(this._$AH)?this._$AA.nextSibling.data=s:this.T(C.createTextNode(s)),this._$AH=s}$(s){let{values:e,_$litType$:t}=s,i=typeof t=="number"?this._$AC(s):(t.el===void 0&&(t.el=q.createElement(Ue(t.h,t.h[0]),this.options)),t);if(this._$AH?._$AD===i)this._$AH.p(e);else{let o=new de(i,this),r=o.u(this.options);o.p(e),this.T(r),this._$AH=o}}_$AC(s){let e=De.get(s.strings);return e===void 0&&De.set(s.strings,e=new q(s)),e}k(s){fe(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,t,i=0;for(let o of s)i===e.length?e.push(t=new n(this.O(K()),this.O(K()),this,this.options)):t=e[i],t._$AI(o),i++;i<e.length&&(this._$AR(t&&t._$AB.nextSibling,i),e.length=i)}_$AR(s=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);s!==this._$AB;){let t=Re(s).nextSibling;Re(s).remove(),s=t}}setConnected(s){this._$AM===void 0&&(this._$Cv=s,this._$AP?.(s))}},D=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(s,e,t,i,o){this.type=1,this._$AH=l,this._$AN=void 0,this.element=s,this.name=e,this._$AM=i,this.options=o,t.length>2||t[0]!==""||t[1]!==""?(this._$AH=Array(t.length-1).fill(new String),this.strings=t):this._$AH=l}_$AI(s,e=this,t,i){let o=this.strings,r=!1;if(o===void 0)s=O(this,s,e,0),r=!W(s)||s!==this._$AH&&s!==M,r&&(this._$AH=s);else{let c=s,a,u;for(s=o[0],a=0;a<o.length-1;a++)u=O(this,c[t+a],e,a),u===M&&(u=this._$AH[a]),r||=!W(u)||u!==this._$AH[a],u===l?s=l:s!==l&&(s+=(u??"")+o[a+1]),this._$AH[a]=u}r&&!i&&this.j(s)}j(s){s===l?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,s??"")}},he=class extends D{constructor(){super(...arguments),this.type=3}j(s){this.element[this.name]=s===l?void 0:s}},pe=class extends D{constructor(){super(...arguments),this.type=4}j(s){this.element.toggleAttribute(this.name,!!s&&s!==l)}},ue=class extends D{constructor(s,e,t,i,o){super(s,e,t,i,o),this.type=5}_$AI(s,e=this){if((s=O(this,s,e,0)??l)===M)return;let t=this._$AH,i=s===l&&t!==l||s.capture!==t.capture||s.once!==t.once||s.passive!==t.passive,o=s!==l&&(t===l||i);i&&this.element.removeEventListener(this.name,this,t),o&&this.element.addEventListener(this.name,this,s),this._$AH=s}handleEvent(s){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,s):this._$AH.handleEvent(s)}},ge=class{constructor(s,e,t){this.element=s,this.type=6,this._$AN=void 0,this._$AM=e,this.options=t}get _$AU(){return this._$AM._$AU}_$AI(s){O(this,s)}};var pt=me.litHtmlPolyfillSupport;pt?.(q,V),(me.litHtmlVersions??=[]).push("3.3.3");var Fe=(n,s,e)=>{let t=e?.renderBefore??s,i=t._$litPart$;if(i===void 0){let o=e?.renderBefore??null;t._$litPart$=i=new V(s.insertBefore(K(),o),o,void 0,e??{})}return i._$AI(n),i};var _e=globalThis,y=class extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let s=super.createRenderRoot();return this.renderOptions.renderBefore??=s.firstChild,s}update(s){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(s),this._$Do=Fe(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return M}};y._$litElement$=!0,y.finalized=!0,_e.litElementHydrateSupport?.({LitElement:y});var ut=_e.litElementPolyfillSupport;ut?.({LitElement:y});(_e.litElementVersions??=[]).push("4.2.2");var gt={attribute:!0,type:String,converter:G,reflect:!1,hasChanged:X},mt=(n=gt,s,e)=>{let{kind:t,metadata:i}=e,o=globalThis.litPropertyMetadata.get(i);if(o===void 0&&globalThis.litPropertyMetadata.set(i,o=new Map),t==="setter"&&((n=Object.create(n)).wrapped=!0),o.set(e.name,n),t==="accessor"){let{name:r}=e;return{set(c){let a=s.get.call(this);s.set.call(this,c),this.requestUpdate(r,a,n,!0,c)},init(c){return c!==void 0&&this.C(r,void 0,n,c),c}}}if(t==="setter"){let{name:r}=e;return function(c){let a=this[r];s.call(this,c),this.requestUpdate(r,a,n,!0,c)}}throw Error("Unsupported decorator location: "+t)};function N(n){return(s,e)=>typeof e=="object"?mt(n,s,e):((t,i,o)=>{let r=i.hasOwnProperty(o);return i.constructor.createProperty(o,t),r?Object.getOwnPropertyDescriptor(i,o):void 0})(n,s,e)}function E(n){return N({...n,state:!0,attribute:!1})}function Ge(n){let s=n.find(t=>t.key==="back"||t.key==="head"),e=n.find(t=>t.key==="legs"||t.key==="feet");return s&&e?{upper:s,lower:e}:void 0}var R=n=>Math.max(0,Math.min(75,n));function Ie(n,s="theme"){let e=R(n.upper.angle??0),t=R(n.lower.angle??0),i=`rotate(${e} 150 70)`,o=`rotate(${-t} 150 70)`,r=c=>c.angle===void 0?"":`${c.label?`${c.label} `:""}${Math.round(R(c.angle))}\xB0`;return ee`
    <svg
  ...
  `}function Ke(n){let s=R(n.left.upper.angle??0),e=R(n.left.lower.angle??0),t=R(n.right.upper.angle??0),i=R(n.right.lower.angle??0),o=(r,c,a,u)=>ee`
    <g
  ...
  `,_([N({attribute:!1})],L.prototype,"hass",2),_([E()],L.prototype,"_config",2);customElements.get("adjustable-bed-card-editor")||customElements.define("adjustable-bed-card-editor",L);var wt=new Set(["back","legs","head","feet"]),b=class extends y{constructor(){super(...arguments);this._activePairedPane="both";this._synchronizationFailed=!1;this._watched=[];this._hold=new ie({pulse:(e,t)=>{if(e.cover)return this.hass?.callService("cover",t==="up"?"open_cover":"close_cover",{entity_id:e.cover});let i=t==="up"?e.up:e.down;return i?this.hass?.callService("button","press",{entity_id:i}):void 0},stopCover:e=>this._cover(e,"stop_cover"),stopBed:e=>{e&&this._press(e)}})}static async getConfigElement(){return document.createElement("adjustable-bed-card-editor")}static getStubConfig(e){return{type:"custom:adjustable-bed-card",device_id:e?Object.values(e.entities).find(i=>i.platform===S)?.device_id:void 0}}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e}getCardSize(){return 8}disconnectedCallback(){super.disconnectedCallback(),this._hold.abandon()}shouldUpdate(e){if(e.has("_config")||e.has("_saveModeFor")||e.has("_activePairedPane")||e.has("_synchronizingTo")||e.has("_synchronizationFailed")||!e.has("hass")||!this.hass)return!0;let t=e.get("hass");if(!t||t.entities!==this.hass.entities||t.devices!==this.hass.devices)return!0;for(let i of this._watched)if(t.states[i]!==this.hass.states[i])return!0;return!1}render(){if(!this.hass||!this._config)return l;if(!this._config.device_id)return this._notice("card.no_device");let e=Ee(this.hass,this._config.device_id),t=ne(this.hass,e);if(e&&t.length)return this._renderPaired(e,t);if(this._config.device_id&&we(this.hass,this._config.device_id))return this._renderSingleAddressPaired(this._config.device_id);let i=x(this.hass,this._config.device_id);return this._watched=this._collectWatched(i),z(i)?this._notice("card.no_entities"):d`
    ...
    `:l}_graphicState(e){let t=e.motors.filter(a=>{let u=a.angle??a.position;return u!==void 0&&this._state(u)?.attributes.unit_of_measurement==="\xB0"});if(t.length===0||t.some(a=>this._angle(a)===void 0))return;let i=Ge(t);if(!i)return;let{upper:o,lower:r}=i,c=e.motors.some(a=>{let u=a.cover?this._state(a.cover)?.state:void 0;return u==="opening"||u==="closing"});return{upperMotor:o,lowerMotor:r,upper:{label:this._motorName(o),angle:this._angle(o)},lower:{label:this._motorName(r),angle:this._angle(r)},moving:c}}_motors(e){let t=e.motors.filter(r=>r.cover||r.up||r.down),i=e.motors.filter(r=>!r.cover&&!r.up&&!r.down&&r.position);if(t.length===0&&i.length===0&&!e.synchro&&!e.stop)return l;let o=t.length>0||i.length>0||!!e.synchro;return d`
    ...
    `}_memory(e){let t=e.memory,i=this._config?.memory_slots;if(i&&i.length){let a=new Set(i.map(Number));t=t.filter(u=>a.has(u.slot))}if(t.length===0)return l;let o=this._config?.memory_save!==!1&&t.some(a=>a.save),r=t.map(a=>a.save??a.goto??String(a.slot)).join("|"),c=this._saveModeFor===r;return d`
